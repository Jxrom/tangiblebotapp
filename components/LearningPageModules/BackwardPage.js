  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.innerContainer}>
        <Text style={styles.innerTitle}>1.2 - Make the Robot Go Backward!</Text>
        ...
        <View style={styles.additionalTextContainer}>
          ...
          <Text style={styles.additionalText}>2. Scan the Backward Card</Text>
          ...
          <Text style={styles.additionalText}>"The robot will move backward"</Text>
        </View>
      </View>
